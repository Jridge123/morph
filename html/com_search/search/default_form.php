...
<form id="searchForm" action="<?php echo JRoute::_( 'index.php?option=com_search' );?>" method="post" name="searchForm">
	...
	<?php echo JText::_( 'Search Keyword' ) .' <b>'. $this->escape($this->searchword) .'</b>'; ?> <span>(<?php echo $this->result; ?>)</span></p>

<?php if($this->total > 0) : ?>
<ul class="search-info">
	<li class="search-counter"><?php echo $this->pagination->getPagesCounter(); ?></li>
    <li class="search-limit"><?php echo JText::_( 'Display Num' ); ?>&nbsp;<?php echo $this->pagination->getLimitBox( ); ?></li>
</ul>
<?php endif; ?>
