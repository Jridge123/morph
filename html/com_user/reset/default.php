...
<div id="user-reset">
	<div id="login-wrap">
		...
		<form action="<?php echo JRoute::_( 'index.php?option=com_user&task=requestreset' ); ?>" method="post" id="login-form" class="josForm form-validate forgot-pass">
			<ul>
				<li class="label"><label for="email" class="hasTip" title="<?php echo JText::_('RESET_PASSWORD_EMAIL_TIP_TITLE'); ?>::<?php echo JText::_('RESET_PASSWORD_EMAIL_TIP_TEXT'); ?>"><?php echo JText::_('Email Address'); ?>:</label>
					<span class="input-wrap"><input id="email" name="email" type="text" class="required validate-email form-input" /></span>
				</li>
				<li class="login-btn">
