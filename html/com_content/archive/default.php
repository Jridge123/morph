...
<?php if ($this->params->get('show_page_title', 1)) : ?>
	<div class="componentheading <?php if ($this->params->get('pageclass_sfx', 1)) : ?> <?php echo $this->params->get('pageclass_sfx')?><?php endif; ?>"><?php echo $this->escape($this->params->get('page_title')); ?></div>
<?php endif; ?>
	<p>
