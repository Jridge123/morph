...
<div class="frontpage-blog <?php echo $this->params->get('pageclass_sfx') ?>">
...
if (($numIntroArticles != $startIntroArticles) && ($i < $this->total)) : ?>
		...
		<?php
			...
			for ($z = 0; $z < $this->params->def('num_columns', 2); $z ++) :
				...
				?>
				<div style="width=<?php echo intval((100 / $this->params->get('num_columns'))-5);?>%;" class="article_column<?php echo $divider ?>">
				<?php
