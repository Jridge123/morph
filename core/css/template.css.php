...
?>
<?php if ( $this->css->logowrap_height ) { ?>#branding,#masthead{height:<?php echo $this->css->logowrap_height; ?>;}<?php } ?>
<?php if ( $this->css->logo_type == 0 ) { ?>/* Text Based Logo */
#branding h1{top:<?php echo $this->css->logo_top; ?>;left:<?php echo $this->css->logo_left; ?>;z-index:<?php echo $this->css->logo_stack; ?>;font-size:<?php echo $this->css->logo_fontsize; ?>;}
#branding h1 a{font-family:<?php echo $this->css->logo_fontfamily; ?>;color:<?php echo $this->css->logo_textcolor; ?>;}
<?php } ?>
<?php if ( $this->css->logo_type == 1 ) { ?>
/* CSS Image Based Logo */
#branding h1{top:<?php echo $this->css->logo_top; ?>;left:<?php echo $this->css->logo_left; ?>;z-index:<?php echo $this->css->logo_stack; ?>;}
#branding h1 a{<?php if(!empty($this->css->logo_size[0])) { ?>width:<?php echo $this->css->logo_size[0]; ?>px;<?php } if(!empty($this->css->logo_size[1])) { ?>height:<?php echo $this->css->logo_size[1]; ?>px;<?php } ?>background-image: url(<?php echo $this->css->logo; ?>);}
...
/* Image Based Logo */
#branding.logotype-2 a.logo-img{top:<?php echo $this->css->logo_top; ?>;left:<?php echo $this->css->logo_left; ?>;z-index:<?php echo $this->css->logo_stack; ?>;}
<?php } if ( $this->css->logo_type == 3 ) { ?>#branding #logo{top:<?php echo $this->css->logo_top; ?>;left:<?php echo $this->css->logo_left; ?>;z-index:<?php echo $this->css->logo_stack; ?>;}
