...
//  
  	// Smooth Scroll
//	jQuery('#k2Container a').click(function(){
//		jQuery.scrollToTop(jQuery(this.hash),500);
//		return false;
//	});
//    	
	// Rating
...
//	}
	...
	jQuery('.classicPopup').removeAttr('href').bind('click', function(){
		var options = eval('(' + jQuery(this).attr('rel') + ')');
		console.log(options);		
