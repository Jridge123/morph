<?php if ( $masthead_show == 0 ) {
   ...
   <div class="<?php echo $site_width . ' ' . $masthead_gridsplit . ' ' . $masthead_chrome; ?>" id="masthead">
      ...
      <div class="<?php echo pt_classes(array('default_menu' => $default_menu, 'subtext_top' => $subtext_top, 'topnav_actionlink' => $topnav_actionlink, 'topdrop' => $topdrop, 'topfish' => $topfish)); ?> horz-nav" id="top">
