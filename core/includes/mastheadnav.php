...
if(file_exists($inc_mastheadnav)) { include_once($inc_mastheadnav); } else { ?>
	...
	<div id="topnav" class="mastheadnav <?php echo $morph->topnav_blockfx.' '; echo pt_classes(array('subtext' => $morph->subtext, 'topnav_actionlink' => $topnav_actionlink, 'topdrop' => $morph->topdrop, 'topfish' => $morph->topfish)); ?>">
