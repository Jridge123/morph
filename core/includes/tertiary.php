...
<div class="sidebar yui-u" id="tertiary-content">
 <?php if ( $tertiary_inner == 1 ) { ?><div class="tertiary-inner clearer"><?php } ?>
    <?php
    if($this->countMenuChildren() || $this->countModules( 'splitright' ) > 0 ) sidebar_module($splitright_chrome, 'splitright', $jj_const, $splitright_modfx, $this, $debug_modules, $nojs);
