...
<ul id="skipto">
		<?php if ($glob->countModules( 'user3' )) : ?>
		...
		<?php if ($glob->countModules( 'splitleft or topleft or left or btmleft' )) : ?>
		...
		<?php endif; if ($glob->countModules( 'splitright or topright or right or btmright' )) : ?>
		<li><a title="Skip to tertiary content" href="<?php JURI::root(); ?>#tertiary-content"><?php echo JText::_('skip to tertiary content'); ?></a></li>
		<?php endif; if ($glob->countModules( 'user1 or user2' )) : ?>
