...
class JElementItoggle extends JElement
{
	/**
	* Element name
	*
	...
	*/
	...
	function fetchTooltip($label, $description, &$node, $control_name='', $name='')
	{
		...
		$output = '<li class="radio-item itoggle-ready"><label class="to-label" id="'.$control_name.$name.'-lbl" for="'.$control_name.$name.'">'.JText::_( $label ).'</label>';
