...
?>
html body{<?php if ( $bg_color && $bg_color !== "#default" ) { ?>background-color:<?php echo $bg_color; ?>;<?php } ?><?php if ( $bg_image && $bg_image !== "default" ) { ?>background-image:url(<?php $_SERVER['DOCUMENT_ROOT']; ?>/morph_assets/backgrounds/<?php echo $bg_image; ?>);<?php } ?>background-repeat:<?php echo $bg_repeat; ?>;background-position:<?php echo $bg_position; ?>;background-attachment:<?php echo $bg_attachment; ?>;}
<?php if ( $logo_type == 0 ) { ?>
#branding h1,#branding h1 a{margin:0;padding:0;}
#branding h1 a{<?php if ( $logo_fontfamily !== "" ) { ?>font-family:<?php echo $logo_fontfamily; ?>;<?php } if ( $logo_fontsize !== "" ) { ?>font-size:<?php echo $logo_fontsize; ?>;<?php } if ( $logo_textcolor && $logo_textcolor !== "#default" ) { ?>color:<?php echo $logo_textcolor; ?>;<?php } ?>}
<?php } if ( $logo_type == 1 ) { ?>
...
<?php } if ( $logo_type == 2 ) { ?>
#branding.plain-txt a{<?php if ( $logo_fontfamily !== "" ) { ?>font-family:<?php echo $logo_fontfamily; ?>;<?php } if ( $logo_fontsize !== "" ) { ?>font-size:<?php echo $logo_fontsize; ?>;<?php } if ( $logo_textcolor && $logo_textcolor !== "#default" ) { ?>color:<?php echo $logo_textcolor; ?>;<?php } ?>}
