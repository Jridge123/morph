...
*** @license   Commercial
**/
$error_reports = $this->params->get('error_reports');
if ($error_reports =="1") { error_reporting(E_ALL ^ E_NOTICE); }
...
<body class="js-disabled <?php echo $themelet ?> <?php echo "$lcbrowser $lcbrowser$ver"; ?>"<?php if ($pageclass != ""){ echo ' id="'.$pageclass.'"'; } ?>>
